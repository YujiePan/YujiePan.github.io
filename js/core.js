...
$(document).ready(function () {
    ...
    readmeURL = 'https://raw.githubusercontent.com/' + user + '/' + user + '.github.io/master/aboutme/AboutMe.md';


    $("#header").text(user + "'s Blog");
    $("#commentsList").removeAttr('data_comments_url');
    $("#tips").html("We never get your username or password, since all the comments are uploaded with HTTPS and Github API. <br> Please turn to <a  target=\"_blank\" href=\"" + issuesHTML + "\">Github issues</a> to make comments if the two-step authentation is on. <br> 我们不会获取您的用户名和密码,评论直接通过 HTTPS 与 Github API交互,<br>如果您开启了两步验证,请在博客的<a  target=\"_blank\" href=\"" + issuesHTML + "\">Github issues</a>下添加 Comment");
...
function setBlogTxt(obj) {
    ...
    $("#title").text(blogName);
    $("#article").html("");
    //$("#article").html("<div class=\"slice\"><div data-loader=\"arrow-circle\"></div></div>");
